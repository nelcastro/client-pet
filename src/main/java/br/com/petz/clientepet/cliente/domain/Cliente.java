...
public class Cliente {
	...
	private LocalDateTime dataHoraDaUltimaLatercao;
	...
	public Cliente(@NotBlank String nomeCompleto, @NotBlank @Email String email, @NotBlank String celular,
			...
			@NotNull Boolean aceitaTermos, LocalDateTime dataHoraDoCadastro, LocalDateTime dataHoraDaUltimaLatercao) {
		...
		this.dataHoraDaUltimaLatercao = dataHoraDaUltimaLatercao;
	}
